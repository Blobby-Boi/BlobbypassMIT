...
- Step 2. Download the BlobbypassPlus.aia file from this repository or click [this link](https://drive.google.com/uc?export=download&id=1PNHu_d8a-DXiWPeLaqVqYtljYPtEgS69).
- Step 3. Go to MIT App Inventor using this url -> [code2.appinventor.mit.edu/](https://code2.appinventor.mit.edu/)
...
This means that your school's WiFi network has a filter on it. Blobbypass and other webview exploits can't do anything about this as they only bypass extensions. If you are on ChromeOS ver 128 or lower, good news! You can do [Blobwifi](https://github.com/Blobby-Boi/Blobwifi) or something similar. But if you aren't that lucky (so most people), then you will need to use some sort of VPN. I recommend [this one](https://www.freevpn.us/pptp/us/) as its pretty fast when I tested it. If that's blocked/won't connect for you, you can always use [this](https://tinyurl.com/BlobeVPN) instead which is slower but works most of the time. Search up a guide on how to import the .onc file onto your Chromebook if you don't know how to do so.
