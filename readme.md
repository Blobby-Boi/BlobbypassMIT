# BlobbypassMIT
### This is the Blobbypass but GUI is remastered and also a full-on browser cuz yes
BlobbypassPlus :O
## How to use
...
- Step 3. Go to MIT App Inventor using this link -> [https://code2.appinventor.mit.edu/]
...
This means that your school's wifi has a filter on it. Blobbypass and other webviews can't do anything about this; they only bypass extensions. If you are on ChromeOS ver 130 or lower, good news! You can do [Blobwifi](https://github.com/Blobby-Boi/Blobwifi). But if you aren't that lucky (most people), then you will need to use some sort of a VPN. I recommend [this one](https://www.freevpn.us/pptp/us/) as its free and pretty fast when I tested it. You can pretty easily search up a guide on how to setup a VPN on your Chromebook if you don't know.
